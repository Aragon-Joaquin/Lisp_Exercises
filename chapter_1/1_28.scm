...
(print "\n")
(print "is 561 a prime number? (no): " (miller-rabin 561))
(print "is 1105 a prime number? (no): " (miller-rabin 1105))
(print "is 5 a prime number? (yes): " (miller-rabin 5))
(print "is 10 a prime number? (no): " (miller-rabin 10))
(print "is 97 a prime number? (yes): " (miller-rabin 97))
